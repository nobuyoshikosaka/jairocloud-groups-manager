...
| status        | character varying(1)         | Yes      |                        | インポート状況                   |
| results       | jsonb                        |          |                        | インポート結果                   |
| not_include   | jsonb                        |          |                        | ファイルに含まれていないユーザー |
...
| location     | character varying(1024) | Yes      |              | ファイルの保存場所           |
