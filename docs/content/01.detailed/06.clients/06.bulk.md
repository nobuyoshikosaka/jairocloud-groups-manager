...
| 型                                                             | 説明                                     |
| -------------------------------------------------------------- | ---------------------------------------- |
| [BulkResponse](../03.entities/11.bulk-request.md#bulkresponse) | 一括レスポンス                           |
| [MapError](../03.entities/04.map-error.md#maperror)            | 一括リクエストに失敗した場合のエラー情報 |
...
5. レスポンスを解析し、 HTTP ステータスコードに応じた処理を行う。
   - ステータスコードが 200 の場合、レスポンスボディを
     [`BulkResponse`](../03.entities/11.bulk-request.md#bulkresponse) のインスタンスにデシリアライズする。
