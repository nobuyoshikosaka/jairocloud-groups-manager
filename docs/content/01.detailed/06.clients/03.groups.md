...
| [MapError](../03.entities/04.map-error.md#maperror) | グループ情報が取得されなかった場合のエラー情報 |
...
5. レスポンスを解析し、 HTTP ステータスコードに応じた処理を行う。
   ...
   - ステータスコードが 400 の場合、レスポンスボディを
     [`MapError`](../03.entities/04.map-error.md#maperror) のインスタンスにデシリアライズする。
...
| [MapError](../03.entities/04.map-error.md#maperror) | グループ情報の登録に失敗した場合のエラー情報 |
...
| [MapError](../03.entities/04.map-error.md#maperror) | グループ情報の更新に失敗した場合のエラー情報 |
...
| 型                                                  | 説明                                     |
| --------------------------------------------------- | ---------------------------------------- |
| [MapError](../03.entities/04.map-error.md#maperror) | グループの削除に失敗した場合のエラー情報 |
