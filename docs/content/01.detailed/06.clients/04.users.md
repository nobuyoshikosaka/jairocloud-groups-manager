...
#### 対応エンドポイント
**GET** [/api/v2/Users](../02.foundation/03.const.md#map_users_endpoint)/{id}
...
| 型                                                  | 説明                                           |
| --------------------------------------------------- | ---------------------------------------------- |
| [MapUser](../03.entities/03.map-user.md#mapuser)    | 取得されたユーザー情報                         |
| [MapError](../03.entities/04.map-error.md#maperror) | ユーザー情報が取得されなかった場合のエラー情報 |
...
5. レスポンスを解析し、 HTTP ステータスコードに応じた処理を行う。
   - ステータスコードが 200 の場合、レスポンスボディを
     [`MapUser`](../03.entities/03.map-user.md#mapuser) のインスタンスにデシリアライズする。
...
#### 対応エンドポイント
**GET** [/api/v2/Existeppn](../02.foundation/03.const.md#map_exist_eppn_endpoint)/{eppn}
...
#### 対応エンドポイント
**POST** [/api/v2/Users](../02.foundation/03.const.md#map_users_endpoint)
...
| 型                                                  | 説明                                         |
| --------------------------------------------------- | -------------------------------------------- |
| [MapUser](../03.entities/03.map-user.md#mapuser)    | 登録されたユーザー情報                       |
| [MapError](../03.entities/04.map-error.md#maperror) | ユーザー情報の登録に失敗した場合のエラー情報 |
...
#### 対応エンドポイント
**PUT** [/api/v2/Users](../02.foundation/03.const.md#map_users_endpoint)/{id}
...
| 型                                                  | 説明                                         |
| --------------------------------------------------- | -------------------------------------------- |
| [MapUser](../03.entities/03.map-user.md#mapuser)    | 更新されたユーザー情報                       |
| [MapError](../03.entities/04.map-error.md#maperror) | ユーザー情報の更新に失敗した場合のエラー情報 |
...
#### 対応エンドポイント
**PATCH** [/api/v2/Users](../02.foundation/03.const.md#map_users_endpoint)/{id}
