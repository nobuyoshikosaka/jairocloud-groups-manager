...
#### シグネチャ
```python[config.py]
class LocalStorageConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class RepositoriesConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class RepositoryIdPatternsConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class GroupsConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class GroupIdPatternsConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class GroupNamePatternsConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class RedisDatabaseConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class RedisSingleConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class RedisSentinelConfig(pydantic.BaseModel):
```
...
#### シグネチャ
```python[config.py]
class SentinelNodeConfig(pydantic.BaseModel):
```
