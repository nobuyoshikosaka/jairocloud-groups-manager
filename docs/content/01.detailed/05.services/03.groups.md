...
10. 作成されたグループ情報を [`GroupDetail`](../03.entities/09.group-detail.md) オブジェクトにマッピングする。
...
8. 取得したグループ情報を [`GroupDetail`](../03.entities/09.group-detail.md#groupdetail) オブジェクトにマッピングする。
...
10. 更新されたグループ情報を [`GroupDetail`](../03.entities/09.group-detail.md#groupdetail) オブジェクトにマッピングする。
...
13. 更新されたグループ情報を [`GroupDetail`](../03.entities/09.group-detail.md) オブジェクトにマッピングする。
