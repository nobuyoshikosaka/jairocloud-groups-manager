...
/* ESSENTIAL SETTINGS  */
const wayfURL: string = wayfConfig.URL
const wayJsURL: string = wayfConfig.jsURL
...
const hideCategories: string[] = wayfConfig.hideCategories
const unhideIdps: string[] = wayfConfig.unhideIdps
...
var wayf_most_used_idps =  ${JSON.stringify(mostUsedIdps)};
...
// [Optional, commented out by default]
var wayf_hide_categories =  ${JSON.stringify(hideCategories)};
...
// [Optional, commented out by default]
var wayf_unhide_idps = ${JSON.stringify(unhideIdps)};
...
// [Optional, commented out by default]
// var wayf_hide_idps = ${JSON.stringify(hideIdps)};
...
// [Optional, commented out by default]
var wayf_additional_idps = ${JSON.stringify(additionalIdPs)};
...
<script type="text/javascript" charset="UTF-8"><!--
    document.write('<script type="text/javascript" src="${wayJsURL}?' + (new Date().getTime()) + '"></scr'+'ipt>');
//-->
<\/script>
...
onMounted(() => {
  const wayfContainer = document.querySelector('#embedded-wayf-iframe')
